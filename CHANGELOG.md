...
- Frizzles (presets 7/9): fitted on sparkle shape (peak, lit count, histogram) and current together instead of current alone — `bri` 200/255 with blur 186/80 (preset 9 now peaks at 168 vs the fork's 177; preset 7 stays current-bound at the gate's 1.13× because stock draws 8 frizzles over 1.6× the cells).
